...
| 已读取 `rules/memory-policy.md` 和 `.cc/changes/task-board.md` | ✅ / ❌ / ⚠️ / N/A |
...
| 已确认哪些知识点需要沉淀到 `.cc/knowledge/` | ✅ / ❌ / ⚠️ / N/A |
| 已确认哪些信息只应留在 change 日志或 task-board，不进入 `.cc/knowledge/` | ✅ / ❌ / ⚠️ / N/A |
...
| `log.md` 完整可读 | ✅ / ❌ / ⚠️ / N/A |
| `.cc/changes/task-board.md` 已同步归档状态并关闭对应阻塞项 | ✅ / ❌ / ⚠️ / N/A |
| 未依赖陈旧验证结果完成归档 | ✅ / ❌ / ⚠️ / N/A |
