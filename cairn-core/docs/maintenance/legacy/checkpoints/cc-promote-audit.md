...
| 检查项 | 结果 |
|--------|------|
| `.cairness/audits/<audit-id>/report.md` 已存在 | ✅ / ❌ / ⚠️ / N/A |
| 本次已明确目标 `change-id` | ✅ / ❌ / ⚠️ / N/A |
| 已读取 `.cairness/changes/task-board.md` | ✅ / ❌ / ⚠️ / N/A |
...
| 已准备将候选 change 摘要写入 `.cairness/changes/task-board.md`，且不替代正式 spec | ✅ / ❌ / ⚠️ / N/A |

## 完成后检查

| 检查项 | 结果 |
|--------|------|
| 已输出 `.cairness/audits/<audit-id>/to-change.md` | ✅ / ❌ / ⚠️ / N/A |
| 已更新 `.cairness/changes/task-board.md` 的 Backlog 候选 | ✅ / ❌ / ⚠️ / N/A |
