...
```yaml
- uses: lq5657/Cairness/.github/actions/cairness@v1.2.2
  with:
    version: 1.2.2
    archive-url: https://github.com/lq5657/Cairness/releases/download/v1.2.2/cairness-1.2.2.tar.gz
    checksums-url: https://github.com/lq5657/Cairness/releases/download/v1.2.2/SHA256SUMS
    mode: full
```
