...
| 已明确本次不会直接进入编码 | ✅ / ❌ / ⚠️ / N/A |
| 已明确本次需要产出项目级文档，而不是 `.cc/changes/<change-id>/` 文档 | ✅ / ❌ / ⚠️ / N/A |
| 已读取 `rules/memory-policy.md`、`.cc/context/dev-map.md` 和 `.cc/changes/task-board.md` | ✅ / ❌ / ⚠️ / N/A |
...
| 未将项目级产物错误写入 `.cc/changes/<change-id>/` | ✅ / ❌ / ⚠️ / N/A |
