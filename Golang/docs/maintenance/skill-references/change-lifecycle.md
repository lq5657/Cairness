...
.claude/scripts/cc-verify --json --output .claude/changes/<change-id>/baseline/post-task-<n>.json --change <change-id>
.claude/scripts/cc-delta-check --before .claude/changes/<change-id>/baseline/pre-apply.json --after .claude/changes/<change-id>/baseline/post-task-<n>.json
```
