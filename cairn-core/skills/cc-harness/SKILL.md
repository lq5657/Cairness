---
name: cc-harness
description: 在 Claude Code 中执行和维护 cc_spec Harness 包。当用户提及任何 cc-* 工作流（如 cc-new-project、cc-preflight、cc-init、cc-enrich-context、cc-explain-system、cc-inspect-codebase、cc-promote-audit、cc-discuss、cc-propose、cc-apply、cc-review、cc-fix、cc-test、cc-archive、cc-help）或要求修改此 Harness 时使用。
---
