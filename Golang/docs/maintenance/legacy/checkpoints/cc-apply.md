...
| 已读取 `context/dev-map.md`、`changes/task-board.md` 和 `rules/memory-policy.md` | ✅ / ❌ / ⚠️ / N/A |
...
| 当前 task 状态已同步到 `changes/task-board.md`，必要的模块导航变化已同步到 `context/dev-map.md` | ✅ / ❌ / ⚠️ / N/A |
...
| changes 文档已更新 | ✅ / ❌ / ⚠️ / N/A |
| `changes/task-board.md` 已记录最新状态、阻塞/依赖和下一命令 | ✅ / ❌ / ⚠️ / N/A |
