...
```yaml
- uses: lq5657/Cairness/.github/actions/cairness@v1.2.4
  with:
    version: 1.2.4
    archive-url: https://github.com/lq5657/Cairness/releases/download/v1.2.4/cairness-1.2.4.tar.gz
    checksums-url: https://github.com/lq5657/Cairness/releases/download/v1.2.4/SHA256SUMS
    mode: full
```
