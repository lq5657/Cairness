...
文件位置：`.claude/docs/examples/changes/user-create-api/review.md`
...
* `spec.md`：`.claude/docs/examples/changes/user-create-api/spec.md`
* `tasks.md`：`.claude/docs/examples/changes/user-create-api/tasks.md`
* `test-spec.md`：`.claude/docs/examples/changes/user-create-api/test-spec.md`
* `log.md`：`.claude/docs/examples/changes/user-create-api/log.md`
