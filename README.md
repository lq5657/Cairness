...
```yaml
- uses: lq5657/Cairness/.github/actions/cairness@v1.2.5
  with:
    version: 1.2.5
    archive-url: https://github.com/lq5657/Cairness/releases/download/v1.2.5/cairness-1.2.5.tar.gz
    checksums-url: https://github.com/lq5657/Cairness/releases/download/v1.2.5/SHA256SUMS
    mode: full
```
