...
> and `.agents/skills/cc-harness/SKILL.md` instead. Codex deterministic
> scripts use `.codex/scripts/*`; Codex lifecycle commands are agent workflows.
> The `.claude/scripts/*` paths below are Claude-only.
