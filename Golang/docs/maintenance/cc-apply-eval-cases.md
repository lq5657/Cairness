...
用于维护者在修改 `cc-apply`、`docs/maintenance/legacy/checkpoints/cc-apply.md`、`rules/verification.md`、`rules/testing-strategy.md` 或相关样例后，快速验证命令是否仍能正确执行最低验证，不再退化成“只保 `go build`”。
...
4. 若未通过，优先修 `docs/maintenance/legacy/commands/cc-apply.md`、`docs/maintenance/legacy/checkpoints/cc-apply.md`、`rules/verification.md`、`rules/testing-strategy.md` 或样例，而不是靠人工提示兜底。
...
**检查方式**：
- 对照 `docs/examples/changes/user-create-api/*`
- 对照 `docs/examples/changes/user-create-api-fix/*`
- 对照 `docs/maintenance/legacy/commands/cc-apply.md`、`docs/maintenance/legacy/checkpoints/cc-apply.md`、`rules/verification.md`
...
- 每次修改 `docs/maintenance/legacy/commands/cc-apply.md` 或 `docs/maintenance/legacy/checkpoints/cc-apply.md` 后，至少回归 Case 2、Case 4、Case 5
- 每次修改 task 模板、执行顺序或并行规则后，至少回归 Case 7
- 每次修改 `rules/verification.md` 或 `rules/testing-strategy.md` 后，至少回归 Case 1、Case 2、Case 3
- 每次修改 `changes/templates/*` 或 `docs/examples/changes/*` 后，至少回归 Case 6
