...
- 文件位置：`docs/examples/changes/user-create-api-fix/spec.md`
...
- `docs/examples/changes/user-create-api/review.md` 中已有首次 review 结论，但本示例假设在更严格审查中追加发现问题
...
- `docs/examples/changes/user-create-api-fix/review.md`
...
| Task 2 | done | `internal/service/user_service_test.go`, `docs/examples/changes/user-create-api-fix/review.md` | 示例省略 baseline 文件；无新增失败 | 补测试和回写 review；仅处理 `open` Findings，保留 `fixed` 审计记录 |
