...
- 输出：`test-spec.md`、测试代码或验证证据、映射状态更新、`.cairness/changes/task-board.md` 状态更新
- 可写文件：测试文件、当前 change 的 `test-spec.md`、`log.md`、`.cairness/changes/task-board.md`，必要时同步 `spec.md` 映射状态
...
- 完成或阻塞时必须同步 `.cairness/changes/task-board.md`，记录本轮测试状态、剩余 gap 和下一命令
