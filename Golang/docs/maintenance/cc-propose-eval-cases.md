...
用于维护者在修改 `cc-propose`、`docs/maintenance/legacy/checkpoints/cc-propose.md` 或相关提问策略后，快速验证命令是否仍能正确处理存量需求、change 澄清边界，以及与项目路线图的桥接关系。
...
4. 若未通过，先修 `docs/maintenance/legacy/commands/cc-propose.md` 或 `docs/maintenance/legacy/checkpoints/cc-propose.md`，再回归。
...
- 每次修改 `docs/maintenance/legacy/commands/cc-propose.md` 或 `docs/maintenance/legacy/checkpoints/cc-propose.md` 后，至少回归 Case 2、Case 3、Case 5
