...
# Runtime context packs are generated by the Harness for agent handoff.  They
# are not business files and must not require a task declaration, while their
# parent directory remains narrow enough that unknown runtime state is still
