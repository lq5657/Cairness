...
文件位置：`.claude/docs/examples/changes/user-create-api-fix/review.md`
...
* `spec.md`：`.claude/docs/examples/changes/user-create-api-fix/spec.md`
* `tasks.md`：`.claude/docs/examples/changes/user-create-api-fix/tasks.md`
* `test-spec.md`：`.claude/docs/examples/changes/user-create-api-fix/test-spec.md`
* `log.md`：`.claude/docs/examples/changes/user-create-api-fix/log.md`
...
| Minor | 文档/注释/import | `.claude/docs/examples/changes/user-create-api-fix/review.md:L1` | ✅ | review 文档已同步 |

#### 5. Findings

| 级别 | 描述 | 位置 | 建议动作 | 状态 |
|------|------|------|----------|------|
| Minor | 示例约束：`cc-fix` 默认只处理 `open` Findings，并在修复后改状态而非删除记录 | `.claude/docs/examples/changes/user-create-api-fix/spec.md:L1` | 后续 fix 继续沿用该约定 | accepted |
