...
- 开始某个 task 前，必须先做 Task Plan Review：确认当前 task 仍然必要、前置依赖已满足、边界清晰、验收标准和验证步骤一一对应、测试要求可执行
...
3. 已满足 `测试要求`，或已记录退化原因
4. 若实现与原计划发生偏差，已先同步 `spec.md`、`tasks.md`、`log.md`
5. 当前 task 的状态、备注、实际改动文件已同步到 change 文档
