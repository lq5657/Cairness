...
- 必须校验：`.claude/` 结构、命令与 checkpoint、schemas、scripts、`harness.config.yaml`、`workflows/cc-workflow.yaml`、`context/dev-map.md`、`changes/task-board.md`、生命周期状态机、命令契约矩阵、角色契约、workflow 角色引用、记忆策略
...
默认以 `docs/adoption/integration-preflight-checklist.md` 作为检查依据。
...
1. 读取 `docs/adoption/integration-preflight-checklist.md`
...
- `docs/maintenance/legacy/checkpoints/cc-preflight.md`
- `docs/adoption/integration-preflight-checklist.md`
