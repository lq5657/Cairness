...
- `cc-inspect-codebase` creates `audits/<audit-id>/report.md`; it does not fix code.
...
- `cc-promote-audit` creates `audits/<audit-id>/to-change.md` and task-board candidates; it does not create `changes/<change-id>/spec.md`.
